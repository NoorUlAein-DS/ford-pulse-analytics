...
# 1. Clean Minimalist Theme (No Cheap Icons, Pure Clean Layout)
st.set_page_config(page_title="Fraud Sentry Dashboard", layout="wide")

st.markdown("""
    <style>
    /* Main App Background - Soft Off-White */
    .stApp { 
...
# 3. Clean Spaced Layout (Using Streamlit Containers - No Buggy HTML)
